...
// Polyfill
console.log(arr.myFindIndex(cb, obj)); // { name: 'suhel' }

// Test with sparse array
const sparseArray = [1, , , 4, 5];
console.log(sparseArray.myFindIndex((el) => el === undefined)); // undefined (treats empty slots as `undefined`)

// Test with no matching element
console.log(arr.myFindIndex((el) => el?.name === "unknown")); // undefined

// Test with thisArg
const thisArg = { name: "nadeem" };
console.log(arr.myFindIndex(cb, thisArg)); // { name: 'nadeem' }
